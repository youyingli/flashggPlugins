...
if options.runMiniAOD:
    ...
    MicroAODTask = prepareflashggMicroAODTask(process, options.processType, options.filename, options.year, condition_dict)
...
process.flashggDiPhotonMVA.diphotonMVAweightfile = cms.FileInPath(str(condition_dict["flashggDiPhotonMVA"]["weightFile"]))
process.flashggDiPhotonMVA.Version = cms.string(str(condition_dict["flashggDiPhotonMVA"]["version"]))
